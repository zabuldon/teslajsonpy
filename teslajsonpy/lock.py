...
class WindowLock(VehicleDevice):
    """Home-assistant lock class for the windows of Tesla vehicles.

    This is intended to be partially inherited by a Home-Assitant entity.
    """

    def __init__(self, data, controller):
        """Initialize the window lock for the vehicle.
