...
from teslajsonpy.homeassistant.alerts import HonkHorn, FlashLight
...
class Controller:
    ...
    def _add_car_components(self, car):
        ...
        self.__components.append(HornSwitch(car, self))
        self.__components.append(FlashLightSwitch(car, self))
